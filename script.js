...
function UpgradeCheck()
{
  ...
  if (Bronze >= 1000 && SilverUnlock == false)
  {
  ...
  if (Silver >= 1000 && GoldUnlock == false)
  {
  ...
  if (Bronze >= 1000)
  {
    ...
    var LeftNum = 0;
    var i;
    AddNum = Math.round(Bronze/1000);
    LeftNum = Math.round(Bronze%1000);
    Bronze = LeftNum;
    for (i = 0; i < AddNum; i++)
    {
      Silver++;
  ...
  if (Silver >= 1000)
  {
    ...
    var LeftNum = 0;
    var i;
    AddNum = Math.round(Silver/1000);
    LeftNum = Math.round(Silver%1000);
    Silver = LeftNum;
    for (i = 0; i < AddNum; i++)
    {
      Gold++;
